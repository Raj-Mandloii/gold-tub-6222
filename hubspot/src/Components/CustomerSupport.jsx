...
export default function CustomerSupport(){
    ...
    return(
        <Flex  color={"rgb(51, 71, 91)"} direction={{base:"column",md:"row",lg:"row"}} gap="10%" mt={{base:"10%",md:"8%",lg:"5%"}} mb={{base:"12%",md:"2%",lg:"2%"}}>
            <Image src="https://static.hsappstatic.net/pricing-pages-unified-ui/static-1.13808/js/img/peopleBlobs/gyasi.jpg" width={{base:"280px",md:"220px",lg:"280px"}} height="337px" />
            <Box >
                <Box  textAlign="left">
                    <Text fontSize={{base:"x-small",md:"small",lg:"small"}} mt={{base:"3%",md:"0",lg:"0"}} >CUSTOMER SUPPORT</Text>
                    <Text fontSize={{base:"xl",md:"2xl",lg:"4xl"}} mt={{base:"3%",md:"0",lg:"0"}} fontWeight="bold" >HubSpot is more than just software.</Text>
