  ...
  return (
    <Flex direction={"column"}>
      ...
      <Show breakpoint='(min-width: 1200px)'>
        <Flex m={6} overflow="hidden" maxH={"95em"} direction={["column", "column", "column", "row",]}>
      ...
      <Flex direction={"column"} alignSelf={"center"} w={"75%"} boxShadow="rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px;">
        <Flex mt={6} p={8} direction={["column", "column", "column", "row"]} >
          ...
          <Flex w={"70%"} textAlign={"start"} direction={"column"} justifyContent={["center", "center", "center", "start"]}
          ...
          <Flex w={["55%", "55%", "55%", "25%"]} direction={"column"} justifyContent={["center", "center", "center", "end"]} alignSelf={["center", "center", "center", "end"]}>
            ...
            <Box>
              ...
              <Flex height={"50px"} bgColor={"gray.300"} m="auto" mt={"4%"}
                borderRadius={"25px"}>
                <Box width={["100%", "100%", "100%", "52%"]} backgroundColor="white" border={"1px solid teal"} borderRadius={"25px"}>
      ...
      <Flex w={"75%"} alignSelf={"center"} justifyContent="space-evenly">
        <Image ml={10} w={['0em', '0em', '0em', "33em"]}
        ...
        <Flex direction={"column"} justifyContent="center">
          ...
          <Button w={"10em"} p={4} mt={"2em"} fontWeight={"300"} fontSize={"13px"} borderRadius={"5px"}
            color={"white"} h={"2em"} bgColor={"#425B76"} >Learn more<Icon ml={1} as={ExternalLinkIcon} /></Button>
        </Flex>
      </Flex>

      {/*  *******************************           CALCULATE YOUR PRICE         **************************************** */}
      <Flex mt={"3em"} h={"auto"} bgImage="https://static.hsappstatic.net/pricing-pages-unified-ui/static-1.13808/js/img/middle-blob.svg"
        pt={"2em"} bgSize={"contain"}

        // h={"auto"}
        minH={"52em"}
        // w={"100%"}
        backgroundPosition={"center"} bgRepeat={"no-repeat"}
        w={"75%"} alignSelf={"center"} justifyContent="center" direction={"column"}>
        <Text fontWeight={"800"} color="#33475B" fontSize={"3xl"} mt="3em" textAlign={"center"}>Calculate Your Price</Text>

        <Flex alignSelf={"center"} justifyContent="center" direction={["column", "column", "column", 'row']}>

          <Flex p={4} bgColor={"white"} borderRadius={"0.7em"} shadow="rgba(99, 99, 99, 0.2) 0px 2px 8px 0px" mt="4em" direction={"column"}>
            <MediumDark content={"Select a Marketing Hub plan:"} />
            {/*   3 BUTTONS INSIDE ROW FLEX */}
            <Flex mb={"1.8em"} ml={"0.5em"} >
              <BigButton contentForText="$50/month" content={"Starter"} src="https://static.hsappstatic.net/pricing-pages-unified-ui/static-1.13808/js/img/productIcons/MarketingHub_Starter.svg" />
              <BigButton iconWidth={"1em"} contentForText="$89/month" content={"Professional"} src="https://static.hsappstatic.net/pricing-pages-unified-ui/static-1.13808/js/img/productIcons/MarketingHub_Pro.svg" />
              <BigButton iconWidth={"1.3em"} contentForText="$3200/month" content={"EnterPrice"} src="https://static.hsappstatic.net/pricing-pages-unified-ui/static-1.13808/js/img/productIcons/MarketingHub_Ent.svg" />
            </Flex>
            ...
            <Box ml="0.7em" textAlign={"start"}>
              ...
              <BrownSmallText ml={"0.4em"} content={`Includes 10,000 marketing contacts. Additional marketing contacts are sold in `} />
              <Flex ml={"0.4em"} >
              ...
              {/* SMALL DIV */}
              <Flex justifyContent={"center"} textAlign={"center"} p={4} bgColor={"white"} borderRadius={"0.1em"} shadow="rgba(99, 99, 99, 0.2) 0px 2px 8px 0px" mt="4em" direction={"column"}>
                <MediumBlack content={"All non-marketing contacts are free, up to a limit of 15 million overall contacts."} />
                <BrownSmallText content={"Only pay for the contacts you want to market to."} />
              ...
              <Flex>
                <Text color={"#425B76"} fontSize={"xs"} >Customize and enhance your plan with additional features.</Text>
                <Spacer />
      ...
      <Flex direction={"column"}>
        <Text mt={10} color={"#33475B"} pl={"0.4em"} fontSize={["12px", "18px", "22px", "30px"]} fontWeight={"800"}>Still have questions about how HubSpot's software</Text>
        <Flex justifyContent={"space-around"}>
          <Text fontSize={["12px", "18px", "22px", "30px"]} ml={"6.7em"} color={"#33475B"} pl={"0.4em"} fontWeight={"800"}>can help your business?</Text>
  ...
  return (
    <Flex direction={"column"} >
      <Flex h={"34em"} bgColor={"white"} borderRadius={"0.7em"} shadow="rgba(99, 99, 99, 0.2) 0px 2px 8px 0px" mt="4em" direction={"column"} >
        ...
        <Text fontSize={"16px"} fontWeight={"300"}>$44,400*</Text>

        <hr style={{ margin: "1em", marginTop: "3em", color: "gray" }} />
        <Flex bgColor={"#F5F8FA"} direction={"column"} textAlign={"start"} p={"1em"} m="1em">
          <MediumDark ml={"10px"} content={"Marketing Hub Enterprise"} />
          <BrownSmallText ml={"12px"} content={"$3,200 per month | 10,000 contacts"} />
        </Flex>
        <hr style={{ marginLeft: "1em", marginRight: "1em", color: "gray" }} />
        <Button alignSelf={"center"} m={""} border={"1em"} fontWeight={400} fontSize={"sm"}
          backgroundColor={"#FF7A59"} color={"white"} width={"80%"} height="50px" mt="5%">Talk to sales</Button>
        {/* <MediumDark className={"underline"} ml={"0em"} content={"View price breakdown"} /> */}
        <Link mt={"1em"} color={"#00AFB2"}>View price breakdown</Link>
        {/* <ExternalLinkIcon/> */}
        {/* <Icon ml={1} as={ExternalLinkIcon} /> */}
        <Link mt={"1em"} color={"#00AFB2"}><Icon mr={2} as={ExternalLinkIcon} />Share this price</Link>
        <BrownSmallText content={"*Includes required, one-time Enterprise Onboarding"} />

        <Flex justifyContent={"center"} alignSelf={"center"}>
          <BrownSmallText content={"for a fee of $6,000."} />
          <Link fontSize={"xs"} color={"#00AFB2"}>Learn more<Icon mr={2} as={ExternalLinkIcon} /></Link>
        </Flex>


      </Flex>
      <Link mt={"1em"} color={"#00AFB2"}>Disclaimer</Link>
    </Flex>
  )
}
...
function LinkText({ content }) {
  return <Text fontWeight={"600"} className='underline' fontSize={"xs"} color="#A4A4A4">{content}</Text>
}

function BrownSmallText({ content, ml }) {
  return <Text ml={ml} fontSize={"xs"} color="#A4A4A4">{content}</Text>
}

function BigButton({ content, contentForText, src, iconWidth }) {
  return (
    <Button border="1px solid #A4A4A4" bgColor={"white"} borderRadius={"0px"} h={"auto"} p={6} pl="3em" pr="3em" display={"inline"}>
      <Flex >
      ...
      <Text fontWeight={"200"} color="#A4A4A4" fontSize={"xs"}>{contentForText}</Text>
    </Button>
  )
}
...
function IconWithText({ content, src, varticleBar }) {
  ...
  return (
    <Box ml={"1.5em"} mt={1} mb={"2em"} display={"flex"}>
      <Image w={"1em"} src={src} />
      <Text color={"#425B76"} textAlign={"start"} mt={"0.2em"} fontSize={"13px"} pl={"0.7em"} pr={"0.7em"}>{content}</Text>
      <Text ml={"1.5em"} color={["white", "white", "white", "#33475B"]}>{varticleBar}</Text>
      {/* {"|"} */}
...
function MediumDark({ content, ml, textAlign, className }) {
  ...
  return (
    <Text className={className} textAlign={!textAlign ? "start" : textAlign} m={2} ml={ml} fontSize={"sm"} fontWeight={"bold"}>{content}</Text>
  )
}

function OrangeButton({ btnContent, color, bgColor, border, m }) {
  return (
    <Button m={!m ? "" : m} border={border} fontWeight={400} fontSize={"sm"} backgroundColor={bgColor} color={color} width={"100%"} height="50px" mt="5%">{btnContent}</Button>
  )
}