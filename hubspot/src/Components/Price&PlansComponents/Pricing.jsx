        ...
        <Box >
            <Box bgColor={"#00B6AB"} >
                <Flex w={"100%"} color={"white"} direction={"column"} justifyContent={"center"} h={"auto"}>
                    ...
                    <Text marginTop={"0.8em"} marginBottom={"2em"} fontSize={["14px", "14px", "14px", "14px"]} >Pay for what you need (when you need it).</Text>
                </Flex>
            </Box>
            <Box bgColor={"#00B6AB"} w={"100%"}>
                <Tabs variant='enclosed-colored' w={"100%"}  colorScheme='gray' >
                   ...
                   <TabList bgColor={"white"}  border={"0px solid white"} >
                        <Tab p={"1.2em"} paddingLeft={"4em"} paddingRight={"4em"} >Product & Plans</Tab>
                        <Tab p={"1.2em"} paddingLeft={"4em"} paddingRight={"4em"}>Bundles</Tab>
                    </TabList>
                   </Flex>
                    <TabPanels>
