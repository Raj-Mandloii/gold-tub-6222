  ...
  return (
    <div>
         <Box mt='4rem' ml="1rem">
              ...
              Who says a CRM is just for Sales? HubSpot CRM comes with free tools for lead generation and email marketing, so
              </Text>
              <Text fontSize="" fontWeight="400" lineHeight="30px" color="gray.600">
              you can actually grow and nurture your database — not just organize it.
              </Text>
