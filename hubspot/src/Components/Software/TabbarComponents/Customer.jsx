  ...
  return (
    <div>
         <Box mt='4rem' ml="1rem">
              ...
              Simple tools that organize communication and keep your whole team focused on the customer. All included in the
              </Text>
          ...
          <Box className={styles.crmImg}>
            <Box align="left" w="38%" mr="2rem" ml="1rem">
              ...
              Manage all your customer communications from one universal inbox.
              </Text>
