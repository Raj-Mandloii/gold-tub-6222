  ...
  return (
    <Flex gap="1.5rem" w="95%" m="auto">
      ...
      <Box>
        ...
        <Flex gap='5px'>
          <Box align='left'>
            <Text mb='11px'> <CheckIcon w='14px'/> Data sync </Text>
            <Text mb='11px'> <CheckIcon w='14px'/> Program <br/><span className={styles.spantTag}>automation</span></Text>
            <Text mb='11px'> <CheckIcon w='14px'/> Data<br/><span className={styles.spantTag}>quality</span></Text>
            <Text mb='11px'> <CheckIcon w='14px'/> Datasets</Text>
          </Box>
          <Box align='left'>
          <Text mb='11px'> <CheckIcon w='14px'/> Snowflake data share</Text>
          <Text mb='11px'> <CheckIcon w='14px'/> Workflow extensions</Text>
          <Text mb='11px'> <CheckIcon w='14px'/> Team management and  <span className={styles.spantTag}>permissions</span></Text>
          <Text mb='11px'> <CheckIcon w='14px'/> Expanded operational <span className={styles.spantTag}>capacity</span></Text>
          </Box>
        </Flex>
      </Box>
    </Flex>
