  ...
  return (
    <Flex gap="1.5rem" w="95%" m="auto">
      ...
      <Box>
        ...
        <Flex>
          <Box align='left'>
            <Text mb='11px'> <CheckIcon w='14px'/> Premium versions</Text>
            <Text mb='11px'> <CheckIcon w='14px'/> Customer service</Text>
            <Text mb='11px'> <CheckIcon w='14px'/> Knowledge base</Text>
            <Text mb='11px'> <CheckIcon w='14px'/> Customer  <span className={styles.spantTag}>feedback </span></Text>
            <Text mb='11px'> <CheckIcon w='14px'/> Multiple ticket</Text>
          </Box>
          <Box align='left'>
          <Text mb='11px'> <CheckIcon w='14px'/> Video creation</Text>
          <Text mb='11px'> <CheckIcon w='14px'/> Custom support form <span className={styles.spantTag}>fields</span></Text>
          <Text mb='11px'> <CheckIcon w='14px'/> Goals</Text>
