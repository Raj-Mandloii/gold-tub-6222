      ...
      <Box>
        ...
        <Flex>
          <Box align='left'>
            ...
            <Text mb='11px'> <CheckIcon w='14px'/> Marketing automation</Text>
            <Text mb='11px'> <CheckIcon w='14px'/> SEO tools</Text>
            <Text mb='11px'> <CheckIcon w='14px'/> Video hosting & <span className={styles.spantTag}>management</span></Text>
          </Box>
          <Box align='left'>
          <Text mb='11px'> <CheckIcon w='14px'/> Social media tools</Text>
          <Text mb='11px'> <CheckIcon w='14px'/> Blog & content <span className={styles.spantTag}>creation tools</span></Text>
          <Text mb='11px'> <CheckIcon w='14px'/> Analytics dashboards</Text>
