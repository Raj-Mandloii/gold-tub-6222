...
export default function CRARightSideComp(){
    ...
    return(
        ...
        <Box  borderTop="2px solid cyan" ml={["-2%","0","0"]} width={["100%","35%","35%"]} boxShadow={"base"} height={["184vh","150vh","184vh"]}>
            ...
            <Box m={["1% 0 1% 32%","5% 0 1% 32%","1% 0 1% 32%"]} width={["45%","55%","45%"]}>
                <Flex justify={"center"} alignItems="center"  mr="42%">
                    <Text fontSize={["xl","2xl","4xl"]} fontWeight="bold">$45</Text>
                    <Text fontSize={["small","medium","large"]} fontWeight="semibold">/mo</Text>
                </Flex>
                <Flex gap={"2%"}>
                    <Text fontSize={["sm","medium","medium"]} fontWeight={"light"}>billed at</Text>
                    <Text fontSize={["sm","medium","medium"]} textDecoration={"line-through"} fontWeight="semibold">$600</Text>
                    <Text fontSize={["sm","medium","medium"]} fontWeight={"semibold"}>$540</Text>
                </Flex>
            </Box>
            <Box  m="5% 2% 1% 0">
            <Text fontSize={["small","medium","medium"]} fontWeight={"semibold"}>ESTIMATED COST TO GET STARTED:</Text>
            ...
            <Flex direction={"column"} justifyContent="space-around"  height={["100vh","45vh","100vh"]}>
            ...
            <Box>
                <Text fontSize={["small","medium","large"]} fontWeight="semibold" mt={"2%"}>Not sure which plan is right for you?</Text>
                <Text fontSize={["small","medium","large"]} fontWeight="semibold">Give us a call.</Text>
                <Text color={"cyan.700"} fontSize={["small","medium","large"]} fontWeight={"semibold"} mt="4%"><PhoneIcon color={"#33475b"} mr="2%"/>+91 11712-79211 </Text>
            </Box>
        </Box>
    )
}